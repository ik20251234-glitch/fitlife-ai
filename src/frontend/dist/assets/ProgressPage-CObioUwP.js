import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, h as useComposedRefs, X, i as cn, q as commonjsGlobal, s as getDefaultExportFromCjs, t as clsx, R as React, v as invariant, b as useProfile, S as Skeleton, B as Button, T as TrendingUp, D as Dumbbell } from "./index-CSO-tJT7.js";
import { C as Card, b as CardHeader, c as CardTitle, d as CardDescription, a as CardContent, B as Badge } from "./index--1ePQYi4.js";
import { d as useControllableState, e as useId, P as Primitive, a as composeEventHandlers, c as createContextScope, f as createSlot, g as createContext2, L as Label$1 } from "./index-DaGsvhi7.js";
import { P as Portal$1, h as hideOthers, R as ReactRemoveScroll, u as useFocusGuards, F as FocusScope, D as DismissableLayer, C as CircleCheck } from "./Combination-Bta016gw.js";
import { P as Presence, I as Input, u as ue } from "./index-CbGGG9T5.js";
import { u as useHealthSummary, F as Flame, T as Target } from "./useHealth-B1RtfeFF.js";
import { a as useProgressHistory, b as useWeeklyStats, u as useRecordDailyProgress } from "./useProgress-Ks_iZDrU.js";
import { m as motion } from "./proxy-BHC_uYLu.js";
import { M as Minus, A as ArrowUp, a as ArrowDown } from "./minus-DGhZjvSR.js";
...
function groupByWeek(records) {
  ...
  const sorted = [...records].sort(
    (a2, b2) => new Date(a2.date).getTime() - new Date(b2.date).getTime()
  );
  ...
  return entries.map(([, recs], i) => ({
    week: `Wk ${i + 1}`,
    totalWorkouts: recs.reduce((s2, r) => s2 + Number(r.workoutsCompleted), 0)
  }));
}
function getDailyCalories(records, target) {
  return Array.from({ length: 7 }, (_, i) => {
    ...
    return {
      day: d2.toLocaleDateString("en-US", { weekday: "short" }),
      calories,
      target,
...
function CustomTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 text-sm shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-1", children: label }),
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground font-semibold", children: [
      p2.name,
      ": ",
      typeof p2.value === "number" ? p2.value.toFixed(1) : p2.value
    ] }, p2.name))
  ] });
}
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-elevated", "data-ocid": ocid, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-4 px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide font-semibold mb-1 truncate", children: label }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10 text-primary flex-shrink-0 ml-2", children: icon })
    ] }),
    trendLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function LogTodayModal({
  ...
  const [workouts, setWorkouts] = reactExports.useState("1");
  const mutation = useRecordDailyProgress();
  function estimateBmi(wt) {
  ...
  async function handleSubmit(e3) {
    ...
    try {
      ...
      ue.success("Progress logged successfully!");
      setCalories("");
      setWorkouts("1");
      onClose();
    } catch {
      ue.error("Failed to log progress. Please try again.");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", "data-ocid": "log_today.dialog", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-foreground font-display", children: "Log Today's Progress" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 mt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "log-weight", className: "text-foreground text-sm", children: "Weight (kg)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "log-weight",
            ...
            value: weight,
            onChange: (e3) => setWeight(e3.target.value),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "log-calories", className: "text-foreground text-sm", children: "Daily Calories Eaten (kcal)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "log-calories",
            ...
            value: calories,
            onChange: (e3) => setCalories(e3.target.value),
            className: "bg-input border-border",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "log-workouts", className: "text-foreground text-sm", children: "Workouts Completed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "log-workouts",
            ...
            max: "10",
            value: workouts,
            onChange: (e3) => setWorkouts(e3.target.value),
            className: "bg-input border-border",
            "data-ocid": "log_today.workouts.input"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "pt-2 gap-2 sm:gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: mutation.isPending ? "Saving…" : "Save Progress"
          }
        )
      ] })
    ] })
...
function ProgressPage() {
  ...
  const calorieTarget = (healthSummary == null ? void 0 : healthSummary.dailyCaloricNeeds) ?? (weeklyStats == null ? void 0 : weeklyStats.averageDailyCalories) ?? 2e3;
  const weekData = groupByWeek(history);
  const dailyData = getDailyCalories(history, calorieTarget);
  const bmiTrend = [...history].sort((a2, b2) => new Date(a2.date).getTime() - new Date(b2.date).getTime()).slice(-8).map((r, i, arr) => ({
    label: i === 0 || i === arr.length - 1 ? formatDate(r.date) : `Wk ${i + 1}`,
    bmi: Number.parseFloat(r.bmi.toFixed(1))
  }));
  const avgBmi = (weeklyStats == null ? void 0 : weeklyStats.averageBMI) ?? 0;
  const totalWorkouts = weeklyStats ? Number(weeklyStats.totalWorkouts) : 0;
  const avgCalories = (weeklyStats == null ? void 0 : weeklyStats.averageDailyCalories) ?? 0;
  const streak = weeklyStats ? Number(weeklyStats.streak) : 0;
  const sortedHistory = [...history].sort(
    (a2, b2) => new Date(a2.date).getTime() - new Date(b2.date).getTime()
  );
  const startWeight = ((_a = sortedHistory[0]) == null ? void 0 : _a.weightKg) ?? (profile == null ? void 0 : profile.weightKg) ?? 0;
  const currentWeight = ((_b = sortedHistory[sortedHistory.length - 1]) == null ? void 0 : _b.weightKg) ?? (profile == null ? void 0 : profile.weightKg) ?? 0;
  const weightChange = currentWeight - startWeight;
  const bmiTrendDir = bmiTrend.length >= 2 ? bmiTrend[bmiTrend.length - 1].bmi - bmiTrend[0].bmi > 0.1 ? "up" : bmiTrend[bmiTrend.length - 1].bmi - bmiTrend[0].bmi < -0.1 ? "down" : "neutral" : "neutral";
  const goal = (profile == null ? void 0 : profile.goal) ?? "Maintain";
  const calDiff = avgCalories - calorieTarget;
  const goalMessage = goal === "LoseWeight" ? calDiff < 0 ? `On track for weight loss: ${Math.abs(Math.round(calDiff))} kcal deficit avg` : `Slightly over target by ${Math.round(calDiff)} kcal/day avg` : goal === "GainWeight" ? calDiff > 0 ? `On track for weight gain: ${Math.round(calDiff)} kcal surplus avg` : `Below caloric surplus target by ${Math.abs(Math.round(calDiff))} kcal/day` : `Maintaining: ${Math.abs(Math.round(calDiff))} kcal ${calDiff >= 0 ? "over" : "under"} target avg`;
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", "data-ocid": "progress.loading_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: ["bmi-sk", "calorie-sk", "workout-sk", "streak-sk"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, k2)) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-8 max-w-7xl mx-auto", "data-ocid": "progress.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-display font-bold text-foreground", children: "Progress Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 text-sm", children: "Track your fitness journey — weekly analytics & trends" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              sub: avgBmi > 0 ? getBMILabel(avgBmi) : void 0,
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-5 h-5" }),
              trend: bmiTrendDir,
              trendLabel: bmiTrendDir === "up" ? "Rising" : bmiTrendDir === "down" ? "Declining" : "Stable",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              trend: totalWorkouts >= 3 ? "up" : totalWorkouts >= 1 ? "neutral" : "down",
              trendLabel: totalWorkouts >= 3 ? "Great consistency!" : totalWorkouts >= 1 ? "Keep it up" : "No workouts logged",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              value: avgCalories > 0 ? Math.round(avgCalories).toLocaleString() : "—",
              sub: `Target: ${Math.round(calorieTarget).toLocaleString()} kcal`,
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "w-5 h-5" }),
              trend: avgCalories === 0 ? "neutral" : Math.abs(avgCalories - calorieTarget) < 100 ? "neutral" : avgCalories > calorieTarget ? "up" : "down",
              trendLabel: avgCalories > 0 ? `${Math.abs(Math.round(avgCalories - calorieTarget))} kcal ${avgCalories > calorieTarget ? "over" : "under"} target` : void 0,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              trendLabel: streak >= 7 ? "🔥 Amazing streak!" : streak >= 3 ? "Building momentum" : "Start your streak",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated", "data-ocid": "progress.bmi_trend.card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-display font-semibold text-foreground", children: "BMI Trend" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs", children: "Last 8 readings with zone reference lines" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: bmiTrend.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No BMI data yet — log your first entry!" })
                ]
              }
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-display font-semibold text-foreground", children: "Caloric Intake" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs", children: "Daily calories vs target — last 7 days" })
                ] }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Bar,
                        {
                          ...
                          name: "Calories",
                          radius: [4, 4, 0, 0],
                          children: dailyData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Cell,
                            {
                              fill: entry.over ? "hsl(var(--chart-3))" : "hsl(var(--chart-1))",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Legend,
                        {
                          content: () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 justify-center mt-2 text-xs text-muted-foreground", children: [
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-display font-semibold text-foreground", children: "Workout Consistency" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs", children: "Workouts per week — last 8 weeks" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: weekData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "h-56 flex flex-col items-center justify-center gap-2 text-muted-foreground",
                    "data-ocid": "progress.workout_consistency.empty_state",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "w-10 h-10 opacity-30" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Log workouts to see consistency trends" })
                    ]
                  }
                ) : weekData.length < 3 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 py-1", children: sortedHistory.slice(-6).reverse().map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: formatDate(r.date) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground truncate", children: [
                            Number(r.dailyCalories).toLocaleString(),
                            " kcal · BMI ",
                            r.bmi.toFixed(1)
                          ] })
                        ] })
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Badge,
                        {
                          variant: Number(r.workoutsCompleted) >= 1 ? "default" : "secondary",
                          className: "text-xs flex-shrink-0",
                          children: [
                            Number(r.workoutsCompleted),
                            " workout",
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-display font-semibold text-foreground", children: "Progress Summary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs", children: "Goal alignment & body composition trends" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4 pt-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-primary/10 border border-primary/20 px-4 py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-4 h-4 text-primary" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-primary uppercase tracking-wide", children: [
                        "Goal:",
                        " ",
                        goal === "LoseWeight" ? "Weight Loss" : goal === "GainWeight" ? "Weight Gain" : "Maintenance"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium", children: goalMessage })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-lg bg-muted/40 border border-border px-4 py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide font-semibold", children: "Weight Change" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-display font-bold text-foreground mt-0.5", children: currentWeight > 0 ? `${currentWeight.toFixed(1)} kg` : "—" }),
                      startWeight > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                        "Starting: ",
                        startWeight.toFixed(1),
                        " kg"
                      ] })
                    ] }),
                    startWeight > 0 && currentWeight > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `flex flex-col items-center gap-0.5 ${weightChange < 0 ? "text-primary" : "text-muted-foreground"}`,
                        style: weightChange > 0 ? { color: "hsl(var(--chart-3))" } : void 0,
                        children: [
                          weightChange < 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-6 h-6" }) : weightChange > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-6 h-6" }),
                  ...
                  bmiTrend.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-lg bg-muted/40 border border-border px-4 py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide font-semibold", children: "Current BMI" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: bmiTrend[bmiTrend.length - 1].bmi.toFixed(1)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                        getBMILabel(bmiTrend[bmiTrend.length - 1].bmi),
                        " range"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `flex flex-col items-center gap-0.5 ${bmiTrendDir === "down" ? "text-primary" : "text-muted-foreground"}`,
                        style: bmiTrendDir === "up" ? { color: "hsl(var(--chart-3))" } : void 0,
                        children: [
                          bmiTrendDir === "down" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-6 h-6" }) : bmiTrendDir === "up" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-6 h-6" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-bold", children: [
                            bmiTrendDir === "up" ? "+" : "",
                            (bmiTrend[bmiTrend.length - 1].bmi - bmiTrend[0].bmi).toFixed(1)
                          ] })
                        ]
                      }
                    )
                  ] }),
                  history.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3.5 h-3.5 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      "Last logged:",
                      " ",
                      formatDate(
                        ((_c = sortedHistory[sortedHistory.length - 1]) == null ? void 0 : _c.date) ?? ""
                      )
                    ] })
                  ] }),
                  history.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-10 h-10 text-muted-foreground opacity-30" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No progress recorded yet." }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      LogTodayModal,
      {
        ...
        currentBmi: (healthSummary == null ? void 0 : healthSummary.latestBMI) ?? avgBmi,
        currentWeight: ((_d = sortedHistory[sortedHistory.length - 1]) == null ? void 0 : _d.weightKg) ?? (profile == null ? void 0 : profile.weightKg) ?? 0
      }
    )
  ] });
}
